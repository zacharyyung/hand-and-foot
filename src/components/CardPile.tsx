...
export function CardPile({
  ...
  /* Match south-hand footprint (CARD_SIZE_CLASS tiny/small). */
  const sizeH = tiny ? 'h-[3.75rem]' : small ? 'h-[4.1rem] sm:h-16' : 'h-24'
  const sizeW = tiny ? 'w-10' : small ? 'w-[2.85rem] sm:w-11' : 'w-16'
