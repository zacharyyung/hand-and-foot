...
/**
 * Full-face art inspired by the classic Bicycle brand joker
 * (crowned king on a bicycle past the 808 milestone).
 */
const BICYCLE_JOKER_SRC = '/bicycle-joker.webp'

function JokerFace() {
  return (
    <img
      src={BICYCLE_JOKER_SRC}
      alt=""
      draggable={false}
      className="playing-card-joker-art"
    />
  )
}
